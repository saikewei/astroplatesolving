...
static void print_to(const tan_t *tan, char *type)
{ // # Modified by Robert Lancaster for the StellarSolver Internal Library to resolve conflict
    debug("%s Structure:\n", type);
...
void tan_print_to(const tan_t *tan)
{ // # Modified by Robert Lancaster for the StellarSolver Internal Library to resolve conflict
    if (tan->sin)
    {
...
void sip_print_to(const sip_t *sip)
{ // # Modified by Robert Lancaster for the StellarSolver Internal Library to resolve conflict
    double det, pixsc;
