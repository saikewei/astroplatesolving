...
{
    return starts_with(columnname, KD_STR_HEADER) ||
...
KD_DECLARE(kdtree_write_fits, int, (kdtree_fits_t * io, const kdtree_t *kd, const qfits_header *inhdr, anbool flip_endian, FILE *fid));
